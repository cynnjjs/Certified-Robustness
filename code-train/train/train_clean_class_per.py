...
def get_so_class_loss(x, y_, y_model, i, grad_fx, FLAGS):
    ...
    # per_i: ? * 784
    per_i = tf.ones_like(grad_fx_ij) * FLAGS.train_epsilon
...
def get_regularization_loss(sess, x, y_, y_model, FLAGS):
    ...
    if(FLAGS.reg_type == 'so_pgd'):
        ...
        for r in range(0, FLAGS.num_classes):
            ...
            # Testing speed issue
            class_loss = get_so_class_loss(x, y_, y_model, r, grad_fx, FLAGS)
...
def train(X_train, Y_train, X_test, Y_test, FLAGS):
    ...
    with sess.as_default():
        ...
        if (FLAGS.reg_type == 'so_pgd'):
            ...
            foso_margin, class_margin = get_regularization_loss(sess, x, y_, y_model, FLAGS)
            ...
            if(FLAGS.loss == 'custom'):
                ...
                for r in range(FLAGS.num_classes):
                    ...
                    Train_step.append(opt.minimize(train_loss))
