"""
Script to run different training algorithms:
a) Normal (no regularization)
b) Frobenius norm/weight decay 
c) Spectral norm 
d) PGD adversarial training
e) First order SDP based regularization 
...
5. msave: where the trained models are being saved 
6. results_dir: directory to save all the results
